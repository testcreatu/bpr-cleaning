	...
	<div class="portlet light bordered">
		<div class="portlet-title">
			<div class="caption">
				...
				<span class="caption-subject font-dark sbold uppercase">Add New about</span>
			</div>
		</div>
		<div class="portlet-body form">
			<form class="form-horizontal" role="form" method="post" action="{{route('add-about')}}" enctype="multipart/form-data">
				{{csrf_field()}}
				<div class="form-body">
					...
					<div class="form-group{{ $errors->has('sub_text') ? ' has-error' : '' }}">
						...
						<div class="col-md-6">
							<input type="text" class="form-control" placeholder="Enter Sub Text" name="sub_text" value="{{old('sub_text')}}">
						</div>
					</div>
