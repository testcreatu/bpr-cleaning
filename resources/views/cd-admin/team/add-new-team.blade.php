	...
	<div class="portlet light bordered">
		<div class="portlet-title">
			<div class="caption">
				...
				<span class="caption-subject font-dark sbold uppercase">Add New Team</span>
			</div>
		</div>
		<div class="portlet-body form">
			<form class="form-horizontal" method="post" action="{{url('cd-admin/insertTeam')}}" enctype="multipart/form-data" role="form">
			@csrf
				<div class="form-body">
					...
					<div class="form-group{{ $errors->has('altimage') ? ' has-error' : '' }}">
						...
						<div class="col-md-6">
							<input type="text" name="altimage" class="form-control" placeholder="Enter about title" value="{{old('altimage')}}">
						</div>
					</div>
					...
					<div class="form-group{{ $errors->has('contact') ? ' has-error' : '' }}">
						...
						<div class="col-md-6">
							<input type="number" class="form-control" placeholder="Enter Contact" name="contact" value="{{old('contact')}}">
						</div>
					</div>
					...
					<div class="form-group{{ $errors->has('fb_link') ? ' has-error' : '' }}">
						...
						<div class="col-md-6">
							<input type="text" class="form-control" placeholder="Enter Link" name="fb_link" value="{{old('fb_link')}}">
						</div>
					</div>
					...
					<div class="form-group{{ $errors->has('insta_link') ? ' has-error' : '' }}">
						...
						<div class="col-md-6">
							<input type="text" class="form-control" placeholder="Enter Link" name="insta_link" value="{{old('insta_link')}}">
						</div>
					</div>
					...
					<div class="form-group{{ $errors->has('twitter_link') ? ' has-error' : '' }}">
						...
						<div class="col-md-6">
							<input type="text" class="form-control" placeholder="Enter Link" name="twitter_link" value="{{old('twitter_link')}}">
						</div>
					</div>
					...
					<div class="form-group{{ $errors->has('birth_date') ? ' has-error' : '' }}">
						...
						<div class="col-md-6">
							<input type="Date" class="form-control" placeholder="Enter Date" name="birth_date" value="{{old('birth_date')}}">
						</div>
					</div>
