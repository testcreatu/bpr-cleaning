...
<div class="page-bar">
	<ul class="page-breadcrumb">
		...
		<li>
			<a href="{{url('cd-admin/view-all-package-category')}}">View all Category</a>
			<i class="fa fa-circle"></i>
		</li>
		<li>
...
<div class="row">
	...
	<div class="portlet light bordered">
		...
		<div class="portlet-body form">
			<form class="form-horizontal" method="POST" action="{{url('/cd-admin/insertCategory')}}" enctype="multipart/form-data" role="form">
				<div class="form-body">
					@csrf
					<div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}">
						<label class="col-md-3 control-label">Enter Course Category Name</label>
						<div class="col-md-6">
