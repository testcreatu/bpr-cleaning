...
<div class="row">
	...
	<div class="portlet light bordered">
		...
		<div class="panel panel-default">
			<div class="panel-heading"><h4>Website URL</h4></div>
			<h5 align="center"><a href="{{$n->website_url}}" target="__blank">{{$n->website_url}}</a></h5>
		</div>
			...
			<form class="form-horizontal" method="post" action="{{url('cd-admin/store-reply',$n->id)}}" enctype="multipart/form-data" role="form">
				<div class="form-body">
					...
					<div class="form-group{{ $errors->has('email') ? ' has-error' : '' }}">
						...
						<div class="col-md-6">
							<input type="text" name="email" class="form-control" placeholder="Enter Receiver`s Email" value="{{$n->email}}" disabled>
					...
					<div class="form-group{{ $errors->has('file_upload[]') ? ' has-error' : '' }}">
						...
						<div class="col-md-6">
							<input type="file" name="file_upload[]" class="form-control" placeholder="Enter Subject" value="{{old('file_upload[]')}}" multiple>
						</div>
					</div>
