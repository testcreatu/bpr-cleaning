    ...
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header">
          <h3 class="modal-title" id="view"><strong>SEO Report Request From {{$er['email']}}</strong> </h3>
        ...
        <div class="modal-body">
         ...
         <p><strong>Website URL : <br></strong><a href="{!!$er['website_url']!!}" target="__blank">{!!$er['website_url']!!}</a> </p>
       </div>
       <div class="modal-footer">
        <a href="{{url('/cd-admin/reply-seo-report/'.$er->id)}}"><button type="submit" class="btn btn-primary pull-left">Reply</button></a>
    ...
    <div class="modal-content">
      <div class="modal-header">
        ...
        <div class="modal-footer">
          ...
          <a href="{{url('/cd-admin/delete-seo-report/'.$er['id'])}}"> <button type="button" class="btn btn-outline">Yes</button></a>
        </div>
      </div>
      <!-- /.modal-content -->
    </div>
