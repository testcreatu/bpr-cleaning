...
<div class="row">
	...
	<div class="portlet light bordered">
		...
		<div class="portlet-body form">
			<form class="form-horizontal" method="post" action="{{url('cd-admin/edit-services/'.$data['id'])}}" enctype="multipart/form-data" role="form">
				<div class="form-body">
					@csrf
					...
					<div class="form-group{{ $errors->has('summary') ? ' has-error' : '' }}">
						...
						<div class="col-md-6">
							<textarea type="text" name="summary" class="form-control" placeholder="Enter Service Summary" value="{{old('summary')}}">{{$data['summary']}}</textarea>
						</div>
					</div>
