...
<div class="page-bar">
	<ul class="page-breadcrumb">
		...
		<li>
			<a href="{{url('cd-admin/view-all-university')}}">View all University</a>
			<i class="fa fa-circle"></i>
		</li>
		<li>
	...
	<div class="portlet light bordered">
		<div class="portlet-title">
			<div class="caption">
				...
				<span class="caption-subject font-dark sbold uppercase">Edit University</span>
			</div>
		</div>
		<div class="portlet-body form">
			<form class="form-horizontal" method="post" action="{{url('cd-admin/updateUniversity/'.$getData->id)}}" enctype="multipart/form-data" role="form">
				<div class="form-body">
				@csrf
				<input type="hidden" name="university_id" value="{{$getData->id}}">
					<div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}">
						...
						<div class="col-md-6">
							<input type="text" name="name" class="form-control" placeholder="Enter about title" value="{{$getData->university_name}}">
						</div>
					</div>
					...
					<div class="form-group{{ $errors->has('altimage') ? ' has-error' : '' }}">
						...
						<div class="col-md-6">
							<input type="text" name="altimage" class="form-control" placeholder="Enter" value="{{$getData->image_description}}">
						</div>
					</div>
					...
					<div class="form-group{{ $errors->has('description') ? ' has-error' : '' }}">
						...
						<div class="col-md-6">
							<div >
							<textarea name="description" id="summernote_1">{{$getData->description}}</textarea> 
							</div>
						</div>
					</div>
