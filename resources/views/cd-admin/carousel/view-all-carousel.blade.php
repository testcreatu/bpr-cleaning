		...
		<div class="portlet light bordered">
			<div class="portlet-title">
				<div class="caption font-dark">
					...
					<span class="caption-subject bold uppercase"> View All Carousel </span>
				</div>
				<div class="btn-group pull-right">
					<a href="{{url('cd-admin/add-carousel')}}">
						<button id="sample_editable_1_new" class="btn sbold green"> Add New Carousel
			...
			<div class="portlet-body">
				<table class="table table-striped table-bordered table-hover table-checkable order-column" id="sample_1">
					...
					<tbody>
					@foreach($car as $blogs)
						<tr class="odd gradeX">
							<td>{{$loop->iteration}}</td>
							<td><img src="{{url('uploads/'.$blogs['image'])}}" alt="" class="img-fluid" style="height: 50px; width: 50px;"></td>
							...
							<td>
								<div class="btn-group">
									...
									<ul class="dropdown-menu pull-left" role="menu">
										...
										<li>
											<a href="{{url('cd-admin/edit-carousel/'.$blogs['id'])}}">
	...
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-footer">
				...
				<a href="{{url('cd-admin/delete-carousel/'.$ch['id'])}}"  class="btn green">YES</a>
			</div>
		</div>
		<!-- /.modal-content -->
	</div>
