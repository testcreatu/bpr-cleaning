			...
			<form class="form-horizontal" role="form" method="post" action="{{route('edit-carousel',$data['id'])}}" enctype="multipart/form-data">
				...
				{{-- 	<div class="form-group{{ $errors->has('description') ? ' has-error' : '' }}">
					...
					<div class="form-group{{ $errors->has('offer_tag') ? ' has-error' : '' }}">
						...
						<div class="col-md-6">
							<input type="text" name="offer_tag" class="form-control" placeholder="Enter Offer Tag" value="{{$data['offer_tag']}}">
						</div>
					...
					<div class="form-group{{ $errors->has('offer_title') ? ' has-error' : '' }}">
						...
						<div class="col-md-6">
							<input type="text" name="offer_title" class="form-control" placeholder="Enter Offer Title" value="{{$data['offer_title']}}">
						</div>
					...
					<div class="form-group{{ $errors->has('offer_sub_text') ? ' has-error' : '' }}">
						...
						<div class="col-md-6">
							<input type="text" name="offer_sub_text" class="form-control" placeholder="Enter Offer Sub Text" value="{{$data['offer_sub_text']}}">
						</div>
						...
						<div class="col-md-6">
							<div class="mt-radio-inline">
								<label class="mt-radio">
									<input type="radio" name="show_offer" id="optionsRadios25" value="show"  <?php echo $data['show_offer'] =='show'?'checked':'' ?>> Show
									<span></span>
								</label>
								<label class="mt-radio">
									<input type="radio" name="show_offer" id="optionsRadios26" value="hide" <?php echo $data['show_offer'] =='hide'?'checked':'' ?>> Hide
									<span></span>
								</label>
							</div>
						</div>
