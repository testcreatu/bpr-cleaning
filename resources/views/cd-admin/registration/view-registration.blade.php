...
<div class="page-bar">
	...
	<li>
		<span>View all Subscription</span>
	</li>
</ul>
</div>
<!-- END PAGE BAR -->
		...
		<div class="portlet light bordered">
			<div class="portlet-title">
				<div class="caption font-dark">
					...
					<span class="caption-subject bold uppercase"> View All Subscription </span>
				</div>
	...
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-footer">
				...
				<a href="{{url('delete-subscription/'.$ch['id'])}}"  class="btn green">YES</a>
			</div>
		</div>
		<!-- /.modal-content -->
	</div>
