			...
			<form class="form-horizontal" method="post" action="{{url('cd-admin/edit-features/'.$data['id'])}}" enctype="multipart/form-data" role="form">
				<div class="form-body">
					...
					<div class="form-group{{ $errors->has('title') ? ' has-error' : '' }}">
						...
						<div class="col-md-6">
							<input type="text" name="title" class="form-control" placeholder="Enter Feature title" value="{{$data['title']}}">
						</div>
					</div>
						...
						<div class="form-group {{ $errors->has('sub_title[]') ? ' has-error' : '' }}">
							...
							<div class="col-sm-6">
								<div class="input-group">
									...
									<input type="text" class="form-control" id="inputTourName3" placeholder="Enter Title" name="sub_title[]" value="{{$f->sub_title}}">
								</div>
							</div>
						</div>
						<div class="form-group {{ $errors->has('sub_summary[]') ? ' has-error' : '' }}">
							...
							<div class="col-sm-6">
								<div class="input-group">
									...
									<textarea class="form-control " rows="5" id="inputDescription3" placeholder="Enter Description" name="sub_summary[]">{!!$f->sub_summary!!}</textarea>
					...
					<div class="form-group">
						<div class="col-sm-11 control-label">
							<div class="col-sm-10">
								<input id="submitButton" type="button" class="add_another_feature btn btn-info" value="Add New  Features"/>
							</div>
						</div>
					</div>
