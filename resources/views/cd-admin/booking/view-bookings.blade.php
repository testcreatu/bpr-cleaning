...
<div class="alert alert-danger">
	...
	<strong>Bookings Deleted Successfully</strong> {{ Session::get('message', '') }}
</div>
@elseif(Session::has('success'))
<div class="alert alert-success">
	<button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
	<strong>Bookings Added Successfully</strong> {{ Session::get('message', '') }}
</div>
		...
		<div class="portlet light bordered">
			<div class="portlet-title">
				<div class="caption font-dark">
					...
					<span class="caption-subject bold uppercase"> View Bookings </span>
				</div>
				{{-- <div class="btn-group pull-right">
					<a href="{{url('cd-admin/add-carousel')}}">
						<button id="sample_editable_1_new" class="btn sbold green"> Add Bookings
